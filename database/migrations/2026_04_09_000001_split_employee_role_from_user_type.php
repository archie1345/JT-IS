...
return new class extends Migration
{
    public function up(): void
    {
        ...
        DB::statement("UPDATE users SET user_type = 'employee' WHERE user_type IN ('jte', 'client')");
    ...
    public function down(): void
    {
        ...
        DB::statement("ALTER TABLE users MODIFY user_type ENUM('jte','employee','admin') NOT NULL DEFAULT 'jte'");
